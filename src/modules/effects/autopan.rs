...
use crate::modules::effects::constants::{AUTO_PAN_LFO_CENTER_VALUE, AUTO_PAN_MAX_WIDTH, AUTO_PAN_MIN_WIDTH};
use crate::synthesizer::midi_value_converters::{exponential_curve_lfo_frequency_from_normal_value, normal_value_to_f32_range, normal_value_to_wave_shape_index};
use crate::synthesizer::OscillatorIndex;
...
impl AutoPan {
    pub fn new(sample_rate: u32) -> Self {
        ...
        lfo.set_center_value(AUTO_PAN_LFO_CENTER_VALUE);
...
impl AudioEffect for AutoPan {
    fn process_samples(&mut self, samples: (f32, f32), effect: &EffectParameters) -> (f32, f32) {
        ...
        if new_frequency != self.lfo_parameters.frequency {
            ...
            self.lfo.set_frequency(exponential_curve_lfo_frequency_from_normal_value(new_frequency));
        }
